...
async def get_neighbour_terms(query_term: QueryTerm) -> PydanticRanking:
    return queryService.process_query(query_term.query, query_term.search_results, query_term.limit_distance, query_term.graph_terms, query_term.selected_categories)
